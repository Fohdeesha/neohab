...
/* The stepping itself lives in common/stepping.ts, shared with the thermostat's setpoint; it is
   re-exported here so the stepper's own callers and checks read it from the module they always
   have. */
