...
const DEFAULT_TAG_UIDS = [
  'Equipment', 'Equipment_AlarmSystem', 'Equipment_Battery', 'Equipment_Blinds', 'Equipment_Boiler',
  'Equipment_Camera', 'Equipment_Car', 'Equipment_CleaningRobot', 'Equipment_Door', 'Equipment_Door_BackDoor',
  'Equipment_Door_CellarDoor', 'Equipment_Door_FrontDoor', 'Equipment_Door_GarageDoor', 'Equipment_Door_Gate',
  'Equipment_Door_InnerDoor', 'Equipment_Door_SideDoor', 'Equipment_Doorbell', 'Equipment_Fan',
  'Equipment_Fan_CeilingFan', 'Equipment_Fan_KitchenHood', 'Equipment_HVAC', 'Equipment_Inverter',
  'Equipment_LawnMower', 'Equipment_Lightbulb', 'Equipment_Lightbulb_LightStripe', 'Equipment_Lock',
  'Equipment_NetworkAppliance', 'Equipment_PowerOutlet', 'Equipment_Projector', 'Equipment_Pump',
  'Equipment_RadiatorControl', 'Equipment_Receiver', 'Equipment_RemoteControl', 'Equipment_Screen',
  'Equipment_Screen_Television', 'Equipment_Sensor', 'Equipment_Sensor_MotionDetector',
  'Equipment_Sensor_SmokeDetector', 'Equipment_Siren', 'Equipment_Smartphone', 'Equipment_Speaker',
  'Equipment_Valve', 'Equipment_VoiceAssistant', 'Equipment_WallSwitch', 'Equipment_WebService',
  'Equipment_WebService_WeatherService', 'Equipment_WhiteGood', 'Equipment_WhiteGood_Dishwasher',
  'Equipment_WhiteGood_Dryer', 'Equipment_WhiteGood_Freezer', 'Equipment_WhiteGood_Oven',
  'Equipment_WhiteGood_Refrigerator', 'Equipment_WhiteGood_WashingMachine', 'Equipment_Window', 'Location',
  'Location_Indoor', 'Location_Indoor_Apartment', 'Location_Indoor_Building',
  'Location_Indoor_Building_Garage', 'Location_Indoor_Building_House', 'Location_Indoor_Building_Shed',
  'Location_Indoor_Building_SummerHouse', 'Location_Indoor_Corridor', 'Location_Indoor_Floor',
  'Location_Indoor_Floor_Attic', 'Location_Indoor_Floor_Basement', 'Location_Indoor_Floor_FirstFloor',
  'Location_Indoor_Floor_GroundFloor', 'Location_Indoor_Floor_SecondFloor',
  'Location_Indoor_Floor_ThirdFloor', 'Location_Indoor_Room', 'Location_Indoor_Room_Bathroom',
  'Location_Indoor_Room_Bedroom', 'Location_Indoor_Room_BoilerRoom', 'Location_Indoor_Room_Cellar',
  'Location_Indoor_Room_DiningRoom', 'Location_Indoor_Room_Entry', 'Location_Indoor_Room_FamilyRoom',
  'Location_Indoor_Room_GuestRoom', 'Location_Indoor_Room_Kitchen', 'Location_Indoor_Room_LaundryRoom',
  'Location_Indoor_Room_LivingRoom', 'Location_Indoor_Room_Office', 'Location_Indoor_Room_Veranda',
  'Location_Outdoor', 'Location_Outdoor_Carport', 'Location_Outdoor_Driveway', 'Location_Outdoor_Garden',
  'Location_Outdoor_Patio', 'Location_Outdoor_Porch', 'Location_Outdoor_Terrace', 'Point', 'Point_Alarm',
  'Point_Control', 'Point_Control_Switch', 'Point_Measurement', 'Point_Setpoint', 'Point_Status',
  'Point_Status_LowBattery', 'Point_Status_OpenLevel', 'Point_Status_OpenState', 'Point_Status_Tampered',
  'Point_Status_Tilt', 'Property', 'Property_CO', 'Property_CO2', 'Property_ColorTemperature',
  'Property_Current', 'Property_Duration', 'Property_Energy', 'Property_Frequency', 'Property_Gas',
  'Property_Humidity', 'Property_Level', 'Property_Light', 'Property_Noise', 'Property_Oil',
  'Property_Opening', 'Property_Power', 'Property_Presence', 'Property_Pressure', 'Property_Rain',
  'Property_Smoke', 'Property_SoundVolume', 'Property_Temperature', 'Property_Timestamp',
  'Property_Ultraviolet', 'Property_Vibration', 'Property_Voltage', 'Property_Water', 'Property_Wind',
]
