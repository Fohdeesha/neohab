...
export function AudioRuntime() {
  ...
  // the leader holds this stream for the whole browser, so it stays open while ANY tab wants audio
  useEffect(() => {
  ...
  useEffect(() => {
    // read on subscribe too: this tab's own setting was published by the effect above, before we were listening
