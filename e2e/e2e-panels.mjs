...
try {
  ...
  const FIT_TYPES = [
    ...
    // all eight value looks: a short tile is where one of them draws outside its own cell
    ['value', { item: ITEMS.temperature, label: 'Value' }],
    ['value', { item: ITEMS.temperature, style: 'stat', label: 'Stat', caption: 'Caption', badge: 'NEW' }],
    ['value', { item: ITEMS.temperature, style: 'spark', label: 'Spark', caption: 'Caption', trend: 'history' }],
    ['value', { item: ITEMS.temperature, style: 'split', label: 'Split', caption: 'Caption', icon: 'mdi:thermometer' }],
    ['value', { item: ITEMS.temperature, style: 'bar', label: 'Bar', caption: 'Caption', min: 0, max: 40 }],
    ['value', { item: ITEMS.temperature, style: 'segment', label: 'Segment', caption: 'Caption' }],
    ['value', { item: ITEMS.temperature, style: 'pill', label: 'Pill', caption: 'Caption' }],
    ['value', { item: ITEMS.temperature, style: 'hero', label: 'Hero', caption: 'Caption' }],
